...
const AppDownload = () => {
  return (
    <div className='max-w-7xl px-4 2xl:px-20 mx-auto my-20'>
        <div className='relative bg-gradient-to-l from-violet-50 to-purple-50 p-12 sm:p-24 lg:p-32 rounded-lg'>
            <div>
